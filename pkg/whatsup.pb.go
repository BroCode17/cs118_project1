...
type ChatMessage struct {
	state         protoimpl.MessageState `protogen:"open.v1"`
	User          string                 `protobuf:"bytes,1,opt,name=user,proto3" json:"user,omitempty"`           // Who sent the message
	Body          string                 `protobuf:"bytes,2,opt,name=body,proto3" json:"body,omitempty"`           // Message content
	Recipient     string                 `protobuf:"bytes,3,opt,name=recipient,proto3" json:"recipient,omitempty"` // Who should receive it
	unknownFields protoimpl.UnknownFields
	sizeCache     protoimpl.SizeCache
}
